...
// LDAP SID structure - based on SAMR_RPC_SID, except the SubAuthority is LE here
 type LDAP_SID_IDENTIFIER_AUTHORITY struct { // Structure: (
         Value [6]byte // 
    }

 type LDAP_SID struct { // Structure: (
         Revision byte // 
...
"""
 type SR_SECURITY_DESCRIPTOR struct { // Structure: (
        ('Revision','c'),
        ('Sbz1','c'),
         Control uint16 // 
         OffsetOwner uint32 // 
...
"""
 type ACE struct { // Structure:
    ...
    SUCCESSFUL_ACCESS_ACE_FLAG  = 0x40 (
     ...
     func (self TYPE) hasFlag(flag interface{}){
...
"""
 type ACCESS_MASK struct { // Structure:
    // Flag constants
    ...
    DELETE                  = 0x00010000 (
     ...
     func (self TYPE) hasPriv(priv interface{}){
        return self.Mask & priv == priv

     func (self TYPE) setPriv(priv interface{}){
        self.Mask |= priv

     func (self TYPE) removePriv(priv interface{}){
        self.Mask ^= priv
...
"""
 type ACCESS_ALLOWED_ACE struct { // Structure:
    ACE_TYPE = 0x00 (
        ('Mask', ':', ACCESS_MASK),
        ('Sid', ':', LDAP_SID)
    }
...
"""
 type ACCESS_ALLOWED_OBJECT_ACE struct { // Structure:
    ACE_TYPE = 0x05
    ...
    @staticmethod
     func checkInheritedObjectType(flags interface{}){
        if flags & ACCESS_ALLOWED_OBJECT_ACE.ACE_INHERITED_OBJECT_TYPE_PRESENT {
            return 16
        return 0

    @staticmethod
     func checkObjectType(flags interface{}){
...
"""
 type ACCESS_DENIED_ACE struct { // ACCESS_ALLOWED_ACE:
    ACE_TYPE = 0x01
...
"""
 type ACCESS_DENIED_OBJECT_ACE struct { // ACCESS_ALLOWED_OBJECT_ACE:
    ACE_TYPE = 0x06
...
"""
 type ACCESS_ALLOWED_CALLBACK_ACE struct { // Structure:
    ACE_TYPE = 0x09 (
        ('Mask', ':', ACCESS_MASK),
        ('Sid', ':', LDAP_SID),
        ('ApplicationData', ':')
...
"""
 type ACCESS_DENIED_CALLBACK_ACE struct { // ACCESS_ALLOWED_CALLBACK_ACE:
    ACE_TYPE = 0x0A
...
"""
 type ACCESS_ALLOWED_CALLBACK_OBJECT_ACE struct { // ACCESS_ALLOWED_OBJECT_ACE:
    ACE_TYPE = 0x0B (
        ('Mask', ':', ACCESS_MASK),
         Flags uint32 // 
        // Optional field
...
"""
 type ACCESS_DENIED_CALLBACK_OBJECT_ACE struct { // ACCESS_ALLOWED_CALLBACK_OBJECT_ACE:
    ACE_TYPE = 0x0C
...
Structure is identical to ACCESS_ALLOWED_ACE
"""
 type SYSTEM_AUDIT_ACE struct { // ACCESS_ALLOWED_ACE:
    ACE_TYPE = 0x02
...
"""
 type SYSTEM_AUDIT_OBJECT_ACE struct { // ACCESS_ALLOWED_CALLBACK_OBJECT_ACE:
    ACE_TYPE = 0x07
...
Structure is identical to ACCESS_ALLOWED_CALLBACK_ACE
"""
 type SYSTEM_AUDIT_CALLBACK_ACE struct { // ACCESS_ALLOWED_CALLBACK_ACE:
    ACE_TYPE = 0x0D
...
"""
 type SYSTEM_MANDATORY_LABEL_ACE struct { // Structure:
    ACE_TYPE = 0x11 (
        ('Mask', ':', ACCESS_MASK),
        ('Sid', ':', LDAP_SID)
    }
...
Structure is identical to ACCESS_ALLOWED_CALLBACK_OBJECT_ACE
"""
 type SYSTEM_AUDIT_CALLBACK_OBJECT_ACE struct { // ACCESS_ALLOWED_CALLBACK_OBJECT_ACE:
    ACE_TYPE = 0x0F
...
"""
 type SYSTEM_RESOURCE_ATTRIBUTE_ACE struct { // ACCESS_ALLOWED_CALLBACK_ACE:
    ACE_TYPE = 0x12
...
"""
 type SYSTEM_SCOPED_POLICY_ID_ACE struct { // ACCESS_ALLOWED_ACE:
    ACE_TYPE = 0x13
