...
PLUGIN_CLASS = "SMBSocksRelay"
 ...
 type SMBSocksRelay struct { // SocksRelay:
    ...
    @staticmethod
     ...
     func (self TYPE) getNegoAnswer(recvPacket interface{}){
     ...
     func (self TYPE) processSessionSetup(recvPacket interface{}){
        ...
        if self.isSMB2 is false {
            ...
            } else if unpack('B', securityBlob[0 {1])[0] == ASN1_SUPPORTED_MECH {
                // AUTH packet
     ...
     func (self TYPE) getLogOffAnswer(recvPacket interface{}){
