...
EOL = "\r\n"
 ...
 type IMAPSocksRelay struct { // SocksRelay:
    ...
    @staticmethod
     ...
     func (self TYPE) getServerCapabilities(){
     ...
     func (self TYPE) processTunnelData(keyword, tag, data interface{}){
     ...
     func (self TYPE) recvPacketClient(){
        data = self.socksSocket.recv(self.packetSize)
        space = data.find(" ")
