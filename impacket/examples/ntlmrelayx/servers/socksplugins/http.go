...
EOL = "\r\n"
 ...
 type HTTPSocksRelay struct { // SocksRelay:
    ...
    @staticmethod
     ...
     func (self TYPE) getHeaders(data interface{}){
     ...
     func (self TYPE) transferResponse(){
     ...
     func (self TYPE) transferChunked(data, headers interface{}){
        headerSize = data.find(EOL+EOL)
     ...
     func (self TYPE) prepareRequest(data interface{}){
