...
PROTOCOL_CLIENT_CLASS = "SMBRelayClient"
 ...
 type MYSMB struct { // SMB:
     func (self TYPE) __init__(remoteName, sessPort = 445, extendedSecurity = true, nmbSession = nil, negPacket=nil interface{}){
        self.extendedSecurity = extendedSecurity
        SMB.__init__(self,remoteName, remoteName, sess_port = sessPort, session=nmbSession, negPacket=negPacket)

     func (self TYPE) neg_session(negPacket=nil interface{}){
        return SMB.neg_session(self, extended_security=self.extendedSecurity, negPacket=negPacket)

 type MYSMB3 struct { // SMB3:
     func (self TYPE) __init__(remoteName, sessPort = 445, extendedSecurity = true, nmbSession = nil, negPacket=nil interface{}){
        self.extendedSecurity = extendedSecurity
 ...
 type SMBRelayClient struct { // ProtocolClient:
    PLUGIN_NAME = "SMB"
     func (self TYPE) __init__(serverConfig, target, targetPort = 445, extendedSecurity=true  interface{}){
     ...
     func (self TYPE) initConnection(){
        ...
        try:
            packet = self.session.negotiateSessionWildcard(nil, self.targetHost, self.targetHost, self.targetPort, 60, self.extendedSecurity,
     ...
     func setUid(self,uid interface{}){
        self._uid = uid
     ...
     func (self TYPE) sendNegotiatev2(negotiateMessage interface{}){
     ...
     func (self TYPE) sendNegotiatev1(negotiateMessage interface{}){
     ...
     func (self TYPE) sendStandardSecurityAuth(sessionSetupData interface{}){
        ...
        if sessionSetupData["Account"] != '' {
            ...
            try:
                ...
                return nil, STATUS_LOGON_FAILURE
            } else  {
                v1client.set_uid(smb["Uid"])
     ...
     func (self TYPE) sendAuthv2(authenticateMessageBlob, serverChallenge=nil interface{}){
        v2client = self.session.getSMBServer()
     ...
     func (self TYPE) sendAuthv1(authenticateMessageBlob, serverChallenge=nil interface{}){
        v1client = self.session.getSMBServer()
