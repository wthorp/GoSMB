...
ERROR_MESSAGES = {
        ...
        0x00000544: ("ERROR_BAD_VALIDATION_CLASS", "The validation information  type requested was invalid."), struct {
        ...
        0x000007d2: ("ERROR_INVALID_WINDOW_STYLE", "The window style or  type attribute is invalid for this operation."), struct {
        ...
        0x00002014: ("ERROR_DS_OBJ_CLASS_VIOLATION", "The requested operation did not satisfy one or more constraints associated with the  type of the object."), struct {
        ...
        0x00002017: ("ERROR_DS_CANT_MOD_OBJ_CLASS", "The directory service detected an attempt to modify the object  type of an object."), struct {
        ...
        0x00002072: ("ERROR_DS_NO_RDN_DEFINED_IN_SCHEMA", "An attempt was made to add an object of a  type that does not have an RDN defined in the schema."), struct {
        ...
        0x00002074: ("ERROR_DS_NO_REQUESTED_ATTS_FOUND", "nil of the requested attributes were found on the objects."),
        ...
        0x0000207b: ("ERROR_DS_OBJECT_CLASS_REQUIRED", "The object  type attribute must be specified."), struct {
        ...
        0x00002097: ("ERROR_DS_CLASS_NOT_DSA", "The object must be of  type DSA."), struct {
        ...
        0x000020a7: ("ERROR_DS_CLASS_MUST_BE_CONCRETE", "The  type of the object must be structural; you cannot instantiate an abstract class."), struct {
        ...
        0x000020b3: ("ERROR_DS_OBJ_CLASS_NOT_DEFINED", "The specified  type is not defined."), struct {
        0x000020b4: ("ERROR_DS_OBJ_CLASS_NOT_SUBCLASS", "The specified  type is not a subclass."), struct {
        ...
        0x000020c5: ("ERROR_DS_AUX_CLS_TEST_FAIL", "Schema update failed:  type in aux-class list does not exist or is not an auxiliary class."), struct {
        0x000020c6: ("ERROR_DS_NONEXISTENT_POSS_SUP", "Schema update failed:  type in poss-superiors does not exist."), struct {
        0x000020c7: ("ERROR_DS_SUB_CLS_TEST_FAIL", "Schema update failed:  type in subclassof list does not exist or does not satisfy hierarchy rules."), struct {
        0x000020c8: ("ERROR_DS_BAD_RDN_ATT_ID_SYNTAX", "Schema update failed: Rdn-Att-Id has wrong syntax."),
        0x000020c9: ("ERROR_DS_EXISTS_IN_AUX_CLS", "Schema deletion failed:  type is used as auxiliary class."), struct {
        0x000020ca: ("ERROR_DS_EXISTS_IN_SUB_CLS", "Schema deletion failed:  type is used as sub class."), struct {
        0x000020cb: ("ERROR_DS_EXISTS_IN_POSS_SUP", "Schema deletion failed:  type is used as poss superior."), struct {
        ...
        0x000020cf: ("ERROR_DS_ATT_SCHEMA_REQ_ID", "Cannot read the governs  type identifier for the schema record."), struct {
        ...
        0x000020d2: ("ERROR_DS_CANT_CACHE_CLASS", "The  type could not be cached."), struct {
        0x000020d3: ("ERROR_DS_CANT_REMOVE_ATT_CACHE", "The attribute could not be removed from the cache."),
        0x000020d4: ("ERROR_DS_CANT_REMOVE_CLASS_CACHE", "The  type could not be removed from the cache."), struct {
        ...
        0x000020f0: ("ERROR_DS_ROOT_REQUIRES_CLASS_TOP", "A root object requires a  type of 'top'."), struct {
        ...
        0x0000211f: ("ERROR_DS_INVALID_LDAP_DISPLAY_NAME", "The LDAP display name of the  type or attribute contains non-ASCII characters."), struct {
        ...
        0x0000212c: ("ERROR_DS_ILLEGAL_XDOM_MOVE_OPERATION", "This object may not be moved across domain boundaries either because cross-domain moves for this  type are disallowed, or the object has some special characteristics, e.g.: trust account or restricted RID, which prevent its move."), struct {
        ...
        0x0000213c: ("ERROR_DS_NONSAFE_SCHEMA_CHANGE", "Adding a new mandatory attribute to an existing class, deleting a mandatory attribute from an existing class, or adding an optional attribute to the special  type Top that is not a backlink attribute  struct { // directly or through inheritance, for example, by adding or deleting an auxiliary class) is not allowed.",
        ...
        0x0000213e: ("ERROR_DS_CANT_CREATE_UNDER_SCHEMA", "An object of this  type cannot be created under the schema container. You can only create attribute-schema and class-schema objects under the schema container."), struct {
        ...
        0x0000277d: ("WSATYPE_NOT_FOUND", "The specified  type was not found."), struct {
