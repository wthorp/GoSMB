...
ERROR_MESSAGES = {
        ...
        0x80004009: ("CO_E_INIT_CLASS_CACHE", "Unable to initialize  type cache."), struct {
        ...
        0x80004015: ("CO_E_WRONG_SERVER_IDENTITY", "The  type is configured to run as a security ID different from the caller."), struct {
        ...
        0x80040008: ("OLE_E_CLASSDIFF", "Linked object's source  type has changed."), struct {
        ...
        0x80040110: ("CLASS_E_NOAGGREGATION", "Class does not support aggregation (or  type object is remote)."), struct {
        ...
        0x800401EC: ("MK_E_NOINVERSE", "Moniker  type has no inverse."), struct {
        ...
        0x800401F3: ("CO_E_CLASSSTRING", "Invalid  type string."), struct {
        ...
        0x800401F8: ("CO_E_DLLNOTFOUND", "DLL for  type not found."), struct {
        ...
        0x800401FE: ("CO_E_APPDIDNTREG", "Application was launched, but it did not register a  type factory."), struct {
        ...
        0x8004020A: ("EVENT_E_MISSING_EVENTCLASS", "A subscription cannot be stored unless its event  type already exists."), struct {
        ...
        0x8004020F: ("EVENT_E_INVALID_EVENT_CLASS_PARTITION", "The event  type for this subscription is in an invalid partition."), struct {
        ...
        0x80080001: ("CO_E_CLASS_CREATE_FAILED", "Attempt to create a  type object failed."), struct {
        ...
        0x80080015: ("CO_E_MISSING_DISPLAYNAME", "The activation requires a display name to be present under the  type identifier  struct { // CLSID) key.",
        ...
        0x80080017: ("CO_E_ELEVATION_DISABLED", "The  type is not configured to support elevated activation."), struct {
        ...
        0x8009202B: ("CRYPT_E_NO_TRUSTED_SIGNER", "nil of the signers of the cryptographic message or certificate trust list is trusted."),
        ...
        0x800F0206: ("SPAPI_E_INVALID_CLASS", "The install  type is not present or is invalid."), struct {
        ...
        0x800F020C: ("SPAPI_E_CANT_LOAD_CLASS_ICON", "The icon representing this install  type cannot be loaded."), struct {
        0x800F020D: ("SPAPI_E_INVALID_CLASS_INSTALLER", "The  type installer registry entry is invalid."), struct {
        0x800F020E: ("SPAPI_E_DI_DO_DEFAULT", "The  type installer has indicated that the default action should be performed for this installation request."), struct {
        ...
        0x800F0215: ("SPAPI_E_NO_CLASSINSTALL_PARAMS", "No  type installer parameters have been set for the device information set or element."), struct {
        ...
        0x800F0218: ("SPAPI_E_NO_CLASS_DRIVER_LIST", "There is no  type driver list for the device information element."), struct {
        ...
        0x800F021E: ("SPAPI_E_NO_SUCH_INTERFACE_CLASS", "This interface  type does not exist in the system."), struct {
        ...
        0x800F022B: ("SPAPI_E_DI_DONT_INSTALL", "The  type installer has denied the request to install or upgrade this device."), struct {
        ...
        0x8011044E: ("COMADMIN_E_EVENTCLASS_CANT_BE_SUBSCRIBER", "An event  type cannot also be a subscriber component."), struct {
