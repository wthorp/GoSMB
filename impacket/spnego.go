...
TypesMech = dict((v,k) for k, v in MechTypes.items())
 ...
 func asn1encode(data = "" interface{}){
 ...
 func asn1decode(data = "" interface{}){
...
// Generic GSSAPI Header Format 
     ...
     func (self TYPE) fromString(data = nil interface{}){
 ...
 type SPNEGO_NegTokenResp: struct {
    ...
    SPNEGO_NEG_TOKEN_TARG = 0xa0
     ...
     func (self TYPE) fromString(data = 0 interface{}){
        payload = data
 ...
 type SPNEGO_NegTokenInit struct { // GSSAPI:
