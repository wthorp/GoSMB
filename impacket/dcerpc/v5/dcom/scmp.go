...
// 2.2.2.1 VSS_OBJECT_TYPE Enumeration
 type VSS_OBJECT_TYPE struct { // NDRENUM:
...
// 2.2.2.2 VSS_MGMT_OBJECT_TYPE Enumeration
 type VSS_MGMT_OBJECT_TYPE struct { // NDRENUM:
     type enumItems struct { // Enum:
...
// 2.2.2.3 VSS_VOLUME_SNAPSHOT_ATTRIBUTES Enumeration
 type VSS_VOLUME_SNAPSHOT_ATTRIBUTES struct { // NDRENUM:
     type enumItems struct { // Enum:
...
// 2.2.3.6 VSS_MGMT_OBJECT_PROP Structure
 type VSS_MGMT_OBJECT_PROP struct { // NDRSTRUCT: (
...
// 3.1.3.1 Next (Opnum 3)
 type IVssEnumMgmtObject_Next struct { // DCOMCALL:
    opnum = 3 (
       ('celt', ULONG),
    }

 type IVssEnumMgmtObject_NextResponse struct { // DCOMANSWER: (
...
// 3.1.2.1 Next (Opnum 3)
 type IVssEnumObject_Next struct { // DCOMCALL:
    opnum = 3 (
       ('celt', ULONG),
    }

 type IVssEnumObject_NextResponse struct { // DCOMANSWER: (
       ('rgelt', VSS_MGMT_OBJECT_PROP),
       ('pceltFetched', ULONG),
       ('ErrorCode', error_status_t),
    }

 type GetProviderMgmtInterface struct { // DCOMCALL:
    opnum = 3 (
       ('ProviderId', VSS_ID),
       ('InterfaceId', VSS_ID),
    }

 type GetProviderMgmtInterfaceResponse struct { // DCOMANSWER: (
       ('ppItf', PMInterfacePointer),
       ('ErrorCode', error_status_t),
    }

 type QueryVolumesSupportedForSnapshots struct { // DCOMCALL:
    opnum = 4 (
       ('ProviderId', VSS_ID),
       ('IContext', LONG),
    }

 type QueryVolumesSupportedForSnapshotsResponse struct { // DCOMANSWER: (
       ('ppEnum', PMInterfacePointer),
       ('ErrorCode', error_status_t),
    }

 type QuerySnapshotsByVolume struct { // DCOMCALL:
    opnum = 5 (
       ('pwszVolumeName', VSS_PWSZ),
       ('ProviderId', VSS_ID),
    }

 type QuerySnapshotsByVolumeResponse struct { // DCOMANSWER: (
       ('ppEnum', PMInterfacePointer),
       ('ErrorCode', error_status_t),
    }

// 3.1.4.4.5 QueryDiffAreasForVolume (Opnum 6)
 type QueryDiffAreasForVolume struct { // DCOMCALL:
    opnum = 6 (
       ('pwszVolumeName', VSS_PWSZ),
    }

 type QueryDiffAreasForVolumeResponse struct { // DCOMANSWER: (
       ('ppEnum', PMInterfacePointer),
       ('ErrorCode', error_status_t),
    }

// 3.1.4.4.6 QueryDiffAreasOnVolume (Opnum 7)
 type QueryDiffAreasOnVolume struct { // DCOMCALL:
    opnum = 7 (
       ('pwszVolumeName', VSS_PWSZ),
    }

 type QueryDiffAreasOnVolumeResponse struct { // DCOMANSWER: (
       ('ppEnum', PMInterfacePointer),
       ('ErrorCode', error_status_t),
    }
...
//###############################################################################
 ...
 type IVssEnumObject struct { // IRemUnknown2:
     func (self TYPE) __init__(interface interface{}){
        IRemUnknown2.__init__(self, interface)
 ...
 type IVssSnapshotMgmt struct { // IRemUnknown2:
     func (self TYPE) __init__(interface interface{}){
        IRemUnknown2.__init__(self, interface)
        self._iid = IID_IVssSnapshotMgmt

     func (self TYPE) GetProviderMgmtInterface(providerId = IID_ShadowCopyProvider, interfaceId = IID_IVssDifferentialSoftwareSnapshotMgmt interface{}){
     ...
     func (self TYPE) QueryVolumesSupportedForSnapshots(providerId, iContext interface{}){
     ...
     func (self TYPE) QuerySnapshotsByVolume(volumeName, providerId = IID_ShadowCopyProvider interface{}){
 ...
 type IVssDifferentialSoftwareSnapshotMgmt struct { // IRemUnknown2:
     func (self TYPE) __init__(interface interface{}){
        IRemUnknown2.__init__(self, interface)
        self._iid = IID_IVssDifferentialSoftwareSnapshotMgmt

     func (self TYPE) QueryDiffAreasOnVolume(pwszVolumeName interface{}){
     ...
     func (self TYPE) QueryDiffAreasForVolume(pwszVolumeName interface{}){
