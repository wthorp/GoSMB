...
//###############################################################################
// 3.2.5.3.4 SASetAccountInformation (Opnum 0)
 type SASetAccountInformation struct { // NDRCALL:
    opnum = 0 (
 ...
 type SASetAccountInformationResponse struct { // NDRCALL: (
        ('ErrorCode',ULONG),
    }

// 3.2.5.3.5 SASetNSAccountInformation (Opnum 1)
 type SASetNSAccountInformation struct { // NDRCALL:
    opnum = 1 (
        ('Handle', PSASEC_HANDLE),
        ('pwszAccount', LPWSTR),
        ('pwszPassword', LPWSTR),
 ...
 type SASetNSAccountInformationResponse struct { // NDRCALL: (
        ('ErrorCode',ULONG),
    }

// 3.2.5.3.6 SAGetNSAccountInformation (Opnum 2)
 type SAGetNSAccountInformation struct { // NDRCALL:
    opnum = 2 (
        ('Handle', PSASEC_HANDLE),
        ('ccBufferSize', DWORD),
 ...
 type SAGetNSAccountInformationResponse struct { // NDRCALL: (
        ('wszBuffer',WORD_ARRAY),
        ('ErrorCode',ULONG),
    }

// 3.2.5.3.7 SAGetAccountInformation (Opnum 3)
 type SAGetAccountInformation struct { // NDRCALL:
    opnum = 3 (
        ('Handle', PSASEC_HANDLE),
        ('pwszJobName', WSTR),
        ('ccBufferSize', DWORD),
 ...
 type SAGetAccountInformationResponse struct { // NDRCALL: (
        ('wszBuffer',WORD_ARRAY),
        ('ErrorCode',ULONG),
    }
//###############################################################################
...
//###############################################################################
 ...
 func hSASetAccountInformation(dce, handle, pwszJobName, pwszAccount, pwszPassword, dwJobFlags=0 interface{}){
 ...
 func hSASetNSAccountInformation(dce, handle, pwszAccount, pwszPassword interface{}){
 ...
 func hSAGetNSAccountInformation(dce, handle, ccBufferSize = MAX_BUFFER_SIZE interface{}){
 ...
 func hSAGetAccountInformation(dce, handle, pwszJobName, ccBufferSize = MAX_BUFFER_SIZE interface{}){
