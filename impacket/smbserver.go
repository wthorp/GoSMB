...
// TODO: Return NT ERROR Codes
 ...
 func computeNTLMv2(identity, lmhash, nthash, serverChallenge, authenticateMessage, ntlmChallenge, type1 interface{}){
 ...
 func outputToJohnFormat(challenge, username, domain, lmresponse, ntresponse interface{}){
...
// ToDo: Document the parameter's types (bytes / string) and check all the places where it's called
 ...
 func writeJohnOutputToFile(hash_string, hash_version, file_name interface{}){
 ...
 func decodeSMBString( flags, text  interface{}){
    if flags & smb.SMB.FLAGS2_UNICODE {
        return text.decode("utf-16le")
    } else  {
        return text

 func encodeSMBString( flags, text  interface{}){
    if flags & smb.SMB.FLAGS2_UNICODE {
        return (text).encode("utf-16le")
    } else  {
        return text.encode("ascii")
    
 func getFileTime(t interface{}){
    t *= 10000000
    t += 116444736000000000
    return t

 func getUnixTime(t interface{}){
    t -= 116444736000000000
    t //= 10000000
    return t

 func getSMBDate(t interface{}){
    // TODO: Fix this :P
 ...
 func getSMBTime(t interface{}){
    // TODO: Fix this :P
    d = datetime.datetime.fromtimestamp(t)
    return (d.hour << 8) + (d.minute << 4) + d.second 

 func getShares(connId, smbServer interface{}){
 ...
 func searchShare(connId, share, smbServer interface{}){
    config = smbServer.getServerConfig()
 ...
 func openFile(path,fileName, accessMode, fileAttributes, openMode interface{}){
 ...
 func queryFsInformation(path, filename, level=0, pktFlags = smb.SMB.FLAGS2_UNICODE interface{}){
 ...
 func findFirst2(path, fileName, level, searchAttributes, pktFlags = smb.SMB.FLAGS2_UNICODE, isSMB2 = false interface{}){
 ...
 func queryDiskInformation(path interface{}){
...
// Here we implement the NT transaction handlers
 type NTTRANSCommands: struct {
     func (self TYPE) default(connId, smbServer, recvPacket, parameters, data, maxDataCount = 0 interface{}){
        pass

// Here we implement the NT transaction handlers
 type TRANSCommands: struct {
    @staticmethod
     func lanMan(connId, smbServer, recvPacket, parameters, data, maxDataCount = 0 interface{}){
        ...
        } else if struct.unpack('<H',parameters[ {2])[0] == 13 {
        ...
        } else if struct.unpack('<H',parameters[ {2])[0] == 1 {
    ...
    @staticmethod
     func transactNamedPipe(connId, smbServer, recvPacket, parameters, data, maxDataCount = 0 interface{}){
        connData = smbServer.getConnectionData(connId)
...
// Here we implement the transaction2 handlers
 type TRANS2Commands: struct {
    // All these commands return setup, parameters, data, errorCode
    @staticmethod
     func setPathInformation(connId, smbServer, recvPacket, parameters, data, maxDataCount = 0 interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func setFileInformation(connId, smbServer, recvPacket, parameters, data, maxDataCount = 0 interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func queryFileInformation(connId, smbServer, recvPacket, parameters, data, maxDataCount = 0 interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func queryPathInformation(connId, smbServer, recvPacket, parameters, data, maxDataCount = 0 interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func queryFsInformation(connId, smbServer, recvPacket, parameters, data, maxDataCount = 0 interface{}){
        connData = smbServer.getConnectionData(connId)
        errorCode = 0
    ...
    @staticmethod
     func findNext2(connId, smbServer, recvPacket, parameters, data, maxDataCount interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func findFirst2(connId, smbServer, recvPacket, parameters, data, maxDataCount interface{}){
        connData = smbServer.getConnectionData(connId)
...
// Here we implement the commands handlers
 type SMBCommands: struct {

    @staticmethod
     func smbTransaction(connId, smbServer, SMBCommand, recvPacket, transCommands interface{}){
        connData = smbServer.getConnectionData(connId)
        ...
        return [respSMBCommand], nil, errorCode


    @staticmethod
     func smbNTTransact(connId, smbServer, SMBCommand, recvPacket, transCommands interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbTransaction2(connId, smbServer, SMBCommand, recvPacket, transCommands interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComLockingAndX(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComClose(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComWrite(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComFlush(connId, smbServer, SMBCommand,recvPacket  interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComCreateDirectory(connId, smbServer, SMBCommand,recvPacket  interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComRename(connId, smbServer, SMBCommand, recvPacket  interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComDelete(connId, smbServer, SMBCommand, recvPacket  interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComDeleteDirectory(connId, smbServer, SMBCommand, recvPacket  interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComWriteAndX(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComRead(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComReadAndX(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbQueryInformation(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbQueryInformationDisk(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComEcho(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComTreeDisconnect(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComLogOffAndX(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComQueryInformation2(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComNtCreateAndX(connId, smbServer, SMBCommand, recvPacket interface{}){
    ...
    @staticmethod
     func smbComOpenAndX(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComTreeConnectAndX(connId, smbServer, SMBCommand, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smbComSessionSetupAndX(connId, smbServer, SMBCommand, recvPacket interface{}){
            ...
            if struct.unpack('B',sessionSetupData["SecurityBlob"][0:1])[0] == ASN1_AID {
               ...
               if len(blob["MechTypes"][0]) > 0 {
                   ...
                   if mechType != TypesMech["NTLMSSP - Microsoft NTLM Security Support Provider"] {
                       ...
                       respSMBCommand["Parameters"] = respParameters
                       respSMBCommand["Data"]       = respData 
                       return [respSMBCommand], nil, STATUS_MORE_PROCESSING_REQUIRED

            } else if struct.unpack('B',sessionSetupData["SecurityBlob"][0 {1])[0] == ASN1_SUPPORTED_MECH {
               // AUTH packet
    ...
    @staticmethod
     func smbComNegotiate(connId, smbServer, SMBCommand, recvPacket  interface{}){
        connData = smbServer.getConnectionData(connId, checkStatus = false)
        ...
        return nil, [resp], STATUS_SUCCESS

    @staticmethod
     func default(connId, smbServer, SMBCommand, recvPacket interface{}){
        ...
        return nil, [packet], errorCode

 type SMB2Commands: struct {
    @staticmethod
     func smb2Negotiate(connId, smbServer, recvPacket, isSMB1 = false interface{}){
        connData = smbServer.getConnectionData(connId, checkStatus = false)
        ...
        return nil, [respPacket], STATUS_SUCCESS

    @staticmethod
     func smb2SessionSetup(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId, checkStatus = false)
        ...
        if struct.unpack('B',securityBlob[0:1])[0] == ASN1_AID {
           ...
           if len(blob["MechTypes"][0]) > 0 {
               ...
               if mechType != TypesMech["NTLMSSP - Microsoft NTLM Security Support Provider"] {
                   ...
                   return [respSMBCommand], nil, STATUS_MORE_PROCESSING_REQUIRED
        } else if struct.unpack('B',securityBlob[0 {1])[0] == ASN1_SUPPORTED_MECH {
           // AUTH packet
    ...
    @staticmethod
     func smb2TreeConnect(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
        ...
        return nil, [respPacket], errorCode

    @staticmethod
     func smb2Create(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smb2Close(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smb2QueryInfo(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smb2SetInfo(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
                ...
                if setInfo["InfoType"] == smb2.SMB2_0_INFO_FILE {
                    ...
                    if informationLevel == smb2.SMB2_FILE_DISPOSITION_INFO {
                        ...
                        if renameInfo["ReplaceIfExists"] == 0 and os.path.exists(newPathName) {
                            return [smb2.SMB2Error()], nil, STATUS_OBJECT_NAME_COLLISION
                        try:
    ...
    @staticmethod
     func smb2Write(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smb2Read(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smb2Flush(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smb2QueryDirectory(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
        ...
        if (recvPacket["TreeID"] in connData["ConnectedShares"]) is false {
            return [smb2.SMB2Error()], nil, STATUS_NETWORK_NAME_DELETED
        ...
        if (fileID in connData["OpenedFiles"]) is false {
            return [smb2.SMB2Error()], nil, STATUS_FILE_CLOSED
        ...
        if os.path.isdir(connData["OpenedFiles"][fileID]["FileName"]) is false {
            return [smb2.SMB2Error()], nil, STATUS_INVALID_PARAMETER

        // If any other information  type is specified in the FileInformationClass  struct {
        ...
        smb2.FILE_BOTH_DIRECTORY_INFORMATION, smb2.FILEID_BOTH_DIRECTORY_INFORMATION, smb2.FILENAMES_INFORMATION):
            return [smb2.SMB2Error()], nil, STATUS_INVALID_INFO_CLASS
        ...
        if errorCode != STATUS_SUCCESS {
            return [smb2.SMB2Error()], nil, errorCode
        ...
        if searchCount == 0 and connData["OpenedFiles"][fileID]["Open"]["EnumerationLocation"] == 0 {
            return [smb2.SMB2Error()], nil, STATUS_NO_SUCH_FILE

        if  connData["OpenedFiles"][fileID]["Open"]["EnumerationLocation"] < 0 {
            return [smb2.SMB2Error()], nil, STATUS_NO_MORE_FILES
    ...
    @staticmethod
     func smb2ChangeNotify(connId, smbServer, recvPacket interface{}){

        return [smb2.SMB2Error()], nil, STATUS_NOT_SUPPORTED

    @staticmethod
     func smb2Echo(connId, smbServer, recvPacket interface{}){

        respSMBCommand = smb2.SMB2Echo_Response()

        return [respSMBCommand], nil, STATUS_SUCCESS

    @staticmethod
     func smb2TreeDisconnect(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smb2Logoff(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smb2Ioctl(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smb2Lock(connId, smbServer, recvPacket interface{}){
        connData = smbServer.getConnectionData(connId)
    ...
    @staticmethod
     func smb2Cancel(connId, smbServer, recvPacket interface{}){
        // I'm actually doing nothing
        return [smb2.SMB2Error()], nil, STATUS_CANCELLED

    @staticmethod
     func default(connId, smbServer, recvPacket interface{}){
        // By default we return an SMB Packet with error not implemented
        smbServer.log("Not implemented command: 0x%x" % recvPacket["Command"],logging.DEBUG)
        return [smb2.SMB2Error()], nil, STATUS_NOT_SUPPORTED
 ...
 type Ioctls: struct {
   @staticmethod
    func fsctlDfsGetReferrals(connId, smbServer, ioctlRequest interface{}){
        return smb2.SMB2Error(), STATUS_FS_DRIVER_REQUIRED

   @staticmethod
    func fsctlPipeTransceive(connId, smbServer, ioctlRequest interface{}){
        connData = smbServer.getConnectionData(connId)
   ...
   @staticmethod
    func fsctlValidateNegotiateInfo(connId, smbServer, ioctlRequest interface{}){
        connData = smbServer.getConnectionData(connId)
 ...
 type SMBSERVERHandler struct { // socketserver.BaseRequestHandler:
     func (self TYPE) __init__(request, client_address, server, select_poll = false interface{}){
        self.__SMB = server
 ...
 type SMBSERVER struct { // socketserver.ThreadingMixIn, socketserver.TCPServer:
// type SMBSERVER struct { // socketserver.ForkingMixIn, socketserver.TCPServer:
     func (self TYPE) __init__(server_address, handler_class=SMBSERVERHandler, config_parser = nil interface{}){
...
// smb2.SMB2_OPLOCK_BREAK:    self.__smb2CommandsHandler.smb2SessionSetup, 
 0xFF:                      self.__smb2CommandsHandler.default
     ...
     func (self TYPE) getIoctls(){
        return self.__smb2Ioctls

     func (self TYPE) getCredentials(){
        return self.__credentials

     func (self TYPE) removeConnection(name interface{}){
        try:
     ...
     func (self TYPE) addConnection(name, ip, port interface{}){
     ...
     func (self TYPE) getActiveConnections(){
        return self.__activeConnections

     func (self TYPE) setConnectionData(connId, data interface{}){
        self.__activeConnections[connId] = data
        //print "setConnectionData" 
        //print self.__activeConnections

     func (self TYPE) getConnectionData(connId, checkStatus = true interface{}){
     ...
     func (self TYPE) getRegisteredNamedPipes(){
        return self.__registeredNamedPipes

     func (self TYPE) registerNamedPipe(pipeName, address interface{}){
        self.__registeredNamedPipes[str(pipeName)] = address
        return true

     func (self TYPE) unregisterNamedPipe(pipeName interface{}){
        if pipeName in self.__registeredNamedPipes {
            del(self.__registeredNamedPipes[str(pipeName)])
            return true
        return false

     func (self TYPE) unregisterTransaction(transCommand interface{}){
        if transCommand in self.__smbTransCommands {
           del(self.__smbTransCommands[transCommand])

     func (self TYPE) hookTransaction(transCommand, callback interface{}){
     ...
     func (self TYPE) unregisterTransaction2(transCommand interface{}){
        if transCommand in self.__smbTrans2Commands {
           del(self.__smbTrans2Commands[transCommand])

     func (self TYPE) hookTransaction2(transCommand, callback interface{}){
     ...
     func (self TYPE) unregisterNTTransaction(transCommand interface{}){
        if transCommand in self.__smbNTTransCommands {
           del(self.__smbNTTransCommands[transCommand])

     func (self TYPE) hookNTTransaction(transCommand, callback interface{}){
     ...
     func (self TYPE) unregisterSmbCommand(smbCommand interface{}){
        if smbCommand in self.__smbCommands {
           del(self.__smbCommands[smbCommand])

     func (self TYPE) hookSmbCommand(smbCommand, callback interface{}){
     ...
     func (self TYPE) unregisterSmb2Command(smb2Command interface{}){
        if smb2Command in self.__smb2Commands {
           del(self.__smb2Commands[smb2Command])

     func (self TYPE) hookSmb2Command(smb2Command, callback interface{}){
        if smb2Command in self.__smb2Commands {
     ...
     func (self TYPE) log(msg, level=logging.INFO interface{}){
     ...
     func (self TYPE) getSMBChallenge(){
        return self.__challenge
  
     func (self TYPE) getServerConfig(){
        return self.__serverConfig

     func (self TYPE) setServerConfig(config interface{}){
        self.__serverConfig = config

     func (self TYPE) getJTRdumpPath(){
        return self.__jtr_dump_path

     func (self TYPE) verify_request(request, client_address interface{}){
        // TODO: Control here the max amount of processes we want to launch
        // returning false, closes the connection
        return true

     func (self TYPE) signSMBv1(connData, packet, signingSessionKey, signingChallengeResponse interface{}){
     ...
     func (self TYPE) signSMBv2(packet, signingSessionKey interface{}){
     ...
     func (self TYPE) processRequest(connId, data interface{}){
     ...
     func (self TYPE) processConfigFile(configFile = nil interface{}){
        // TODO: Do a real config parser
        if self.__serverConfig == nil {
            if configFile == nil {
                configFile = "smb.conf"
     ...
     func (self TYPE) addCredential(name, uid, lmhash, nthash interface{}){
...
from impacket.system_errors import ERROR_INVALID_LEVEL
 ...
 type WKSTServer struct { // DCERPCServer:
     ...
     func NetrWkstaGetInfo(self,data interface{}){
 ...
 type SRVSServer struct { // DCERPCServer:
     func (self TYPE) __init__(){
        DCERPCServer.__init__(self)

        self._shares = {}
        self.__serverConfig = nil
        self.__logFile = nil
     ...
     func NetrShareGetInfo(self,data interface{}){
     ...
     func NetrServerGetInfo(self,data interface{}){
     ...
     func (self TYPE) NetrShareEnum(data interface{}){
 ...
 type SimpleSMBServer: struct {
    """
    SimpleSMBServer  type - Implements a simple, customizable SMB Server struct {
    ...
    :param string configFile: a file with all the servers' configuration. If no file specified, this  type will create the basic parameters needed to run. You will need to add your shares manually tho. See addShare struct { //  method
    """
     func (self TYPE) __init__(listenAddress = "0.0.0.0", listenPort=445, configFile='' interface{}){
        if configFile != '' {
            self.__server = SMBSERVER((listenAddress,listenPort))
            self.__server.processConfigFile(configFile)
            self.__smbConfig = nil
        } else  {
            ...
            self.__smbConfig.set('global','log_file','nil')
     ...
     func (self TYPE) addShare(shareName, sharePath, shareComment='', shareType = 0, readOnly = "no" interface{}){
     ...
     func (self TYPE) removeShare(shareName interface{}){
     ...
     func (self TYPE) setSMBChallenge(challenge interface{}){
        if challenge != '' {
            self.__smbConfig.set('global', 'challenge', unhexlify(challenge))
            self.__server.setServerConfig(self.__smbConfig)
            self.__server.processConfigFile()
        
     func (self TYPE) setLogFile(logFile interface{}){
        self.__smbConfig.set('global','log_file',logFile)
        self.__server.setServerConfig(self.__smbConfig)
        self.__server.processConfigFile()

     func (self TYPE) setCredentialsFile(logFile interface{}){
