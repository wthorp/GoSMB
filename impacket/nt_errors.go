...
ERROR_MESSAGES = {
        ...
        0xC0000003: ("STATUS_INVALID_INFO_CLASS","{Invalid Parameter} The specified information  type is not a valid information class for the specified object."), struct {
        ...
        0xC0000073: ("STATUS_NONE_MAPPED","nil of the information to be translated has been translated."),
        ...
        0xC00000A7: ("STATUS_BAD_VALIDATION_CLASS","The validation information  type requested was invalid."), struct {
        ...
        0xC00002AB: ("STATUS_DS_OBJ_CLASS_VIOLATION","The requested operation did not satisfy one or more constraints that are associated with the  type of the object."), struct {
        ...
        0xC00002AE: ("STATUS_DS_CANT_MOD_OBJ_CLASS","The directory service detected an attempt to modify the object  type of an object."), struct {
