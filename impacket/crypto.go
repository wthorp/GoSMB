...
from six import b
 ...
 func Generate_Subkey(K interface{}){
...
//   +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 func PAD(N interface{}){
    padLen = 16-len(N)
    return  N + b'\x80' + b'\x00'*(padLen-1)

 func AES_CMAC(K, M, length interface{}){
...
//   +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 func AES_CMAC_PRF_128(VK, M, VKlen, Mlen interface{}){
//   +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//   +                        AES-CMAC-PRF-128                           +
//   +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//   +                                                                   +
...
//   +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 func KDF_CounterMode(KI, Label, Context, L interface{}){
...
// [MS-LSAD] Section 5.1.2 / 5.1.3
 ...
 func transformKey(InputKey interface{}){
    // Section 5.1.3
    OutputKey = []
 ...
 func decryptSecret(key, value interface{}){
    // [MS-LSAD] Section 5.1.2
    plainText = b''
    key0 = key
 ...
 func encryptSecret(key, value interface{}){
    // [MS-LSAD] Section 5.1.2
    cipherText = b''
    key0 = key
 ...
 func SamDecryptNTLMHash(encryptedHash, key interface{}){
    // [MS-SAMR] Section 2.2.11.1.1
 ...
 func SamEncryptNTLMHash(encryptedHash, key interface{}){
    // [MS-SAMR] Section 2.2.11.1.1
    Block1 = encryptedHash[:8]
    Block2 = encryptedHash[8:]
